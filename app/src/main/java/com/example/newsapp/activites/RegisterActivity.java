...
public class RegisterActivity extends AppCompatActivity {
    EditText usernameEd, emailEd, passwordEd, cPasswordEd;
    Button clearBtn;
    //view binding
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clearBtn.setOnClickListener(view-> clearInput());
    }
    ...
    private void validateData() {
        ...
        if (TextUtils.isEmpty(name)){
            ...
            //email is either not entered or email pattern is invalid, don't allow to continue is that case
            Toast.makeText(this, "Invalid email pattern...!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(password)){
            //password edit text is empty, must enter confirm password
