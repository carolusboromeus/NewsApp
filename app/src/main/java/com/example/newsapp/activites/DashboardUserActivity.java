...
import com.example.newsapp.NewsUserFragment;
...
public class DashboardUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.contactButton.setOnClickListener(v -> startActivity(new Intent(DashboardUserActivity.this, ContactUs.class)));
    ...
    private void setupViewPagerAdapter(ViewPager viewPager) {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                viewPagerAdapter.addFragment(NewsUserFragment.newInstance(
                        ""+modelAll.getId(),
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        private ArrayList<NewsUserFragment>  fragmentList = new ArrayList<>();
        ...
        private void addFragment(NewsUserFragment fragment, String title) {
            ...
            ref.child(firebaseAuth.getUid())
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            binding.subTitleTv.setText("Halo "+name);
                        }
