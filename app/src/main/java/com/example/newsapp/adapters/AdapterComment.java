...
import com.example.newsapp.databinding.RowCommentBinding;
...
public class AdapterComment extends RecyclerView.Adapter<AdapterComment.HolderComment> {
    ...
    public void onBindViewHolder(@NonNull HolderComment holder, int position) {
        /*---Get data form specific position of list, set data, handle click etc.---*/

        //get data
        ModelComment modelComment = commentArrayList.get(position);
        String id = modelComment.getId();
        String newsId = modelComment.getNewsId();
        ...
        builder.setTitle("Delete Comment")
                ...
                .setPositiveButton("DELETE", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ref.child(modelComment.getNewsId())
                                .child("Comments")
